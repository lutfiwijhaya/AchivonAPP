...
public class EmployeeRehabilitation extends MasterForm {
    ...
    private void initComponents() {
        ...
        jPanel1.add(sendButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(880, 710, 170, 50));
    ...
    private void tracer(){
        String templateFilePath = "src/Doc/Employment Rehabilitation.xlsx";
        ...
        try {
            ...
            if (iconHRRevd == null) {
                ...
                Picture picture = drawing.createPicture(anchor, pictureIdx);
                picture.resize(1.0, 1.0);
                sheet.getRow(6).getCell(10).setCellValue(labelNameHRRevd.getText().trim());
            }
            ...
            if (iconTeamMGR == null) {
                ...
                Picture picture = drawing.createPicture(anchor, pictureIdx);
                picture.resize(1.0, 1.0);
                sheet.getRow(6).getCell(7).setCellValue(labelNameTeamMGR.getText().trim());
            }
            ...
            sheet.getRow(9).getCell(11).setCellValue(dateJoin.getText());
            sheet.getRow(10).getCell(11).setCellValue(dateLeave.getText());
            sheet.getRow(11).getCell(11).setCellValue(dateRehab.getText());
            sheet.getRow(12).getCell(11).setCellValue(labelHP.getText());
            
            sheet.getRow(15).getCell(0).setCellValue(stateRehab.getText());
            sheet.getRow(23).getCell(0).setCellValue(documentRehab.getText());
