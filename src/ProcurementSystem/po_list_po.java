 ...
 * @author USER
 */
public class po_list_po extends MasterForm {
    ...
    void tampil_table() {
        ...
        try {
            ...
            rs = stm.executeQuery("SELECT * FROM po inner join po_sq on po.sq_id = po_sq.id INNER JOIN po_rfq on po_sq.rfq_id = po_rfq.id inner join biz_partner on biz_partner.biz_id = po_rfq.biz_id  where po.status_po = '0'");
            while (rs.next()) {
                ...
                String[] data = {
                    "PO-" + rs.getString("id_po"),
                    "SQ-" + rs.getString("rfq_id"),
                    rs.getString("name"),
                    rs.getString("po.po_date"),
                    rs.getString("po.po_delivery_date"),
                    rs.getString("po.description"),
                    "Rp. " + hasil,
                    rs.getString("disc") + "%",
                    "Rp. " + hasil1,
                    "Rp. " + hasil2,
    ...
    void tampil_table2() {
        ...
        try {
            stm = koneksi.createStatement();
            rs = stm.executeQuery("SELECT * FROM po_sq inner join po_rfq on po_sq.rfq_id = po_rfq.id inner join po_rfq_items on po_rfq.id = po_rfq_items.rfq_id where po_sq.id = '" + id + "'");
            while (rs.next()) {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "PO ID", "SQ ID", "Supplier", "PO Date", "PO Delivery", "Description", "Amount", "Disc", "Total1", "PPN", "Total2"
            }
        ) {
        ...
        jLabel3.setText("LIST PURCHASE ORDER");
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "MR ID", "Material Name", "Stock Needs", "Price", "Total"
            }
        ) {
            boolean[] canEdit = new boolean [] {
...
CustomResource.CandidateSession.setidpo(id);
